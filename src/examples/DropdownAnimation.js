...
export default function DropdownAnimation({ onBack }) {
  ...
  return (
    <div className="example-page">
      <header className="example-header">
        ...
        <span className="example-label">01 — Dropdown Animation</span>
      </header>
      <div className="dropdown-stage-wrap">
        <div className="stage">
          <div className="col">
            <BadDropdown
